"""Project constants and path helpers for steering framework."""
...
PAPER_MODE_NAME = "anthropic_emotions_2026"
DEFAULT_VECTOR_DIM = 256
DEFAULT_NUM_LAYERS = 32
DEFAULT_HIDDEN_SIZE = 256
DEFAULT_POOLING_MIN_TOKEN_INDEX = 50
DEFAULT_MAX_LENGTH = 2048

DEFAULT_ALPHA_MIN = -0.1
DEFAULT_ALPHA_MAX = 0.1
DEFAULT_ALPHA_STEP = 0.025

# Locked paper-style generation defaults.
PAPER_STORIES_PER_TOPIC_EMOTION = 1
PAPER_DIALOGUES_PER_TOPIC_EMOTION = 1
PAPER_NEUTRAL_DIALOGUES_PER_TOPIC = 2
...
def project_root() -> Path:
    env_root = os.environ.get("ART_PROJECT_ROOT")
    if env_root:
...
def runs_root() -> Path:
    return project_root() / RUNS_ROOT_NAME
